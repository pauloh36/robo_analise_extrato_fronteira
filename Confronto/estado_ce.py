...
class Estado_ce:
    ...
    def logica_ce(self, arquivo_atual, caminho_arquivo, caminho_nfs_nao_efetivadas, filial_filtro, df_save):
        ...
        receita_1031 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 1031.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
        )

        receita_2020 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 2020.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
        )

        soma_cods_sefaz = [receita_1031, receita_2020]
        ...
        analiseStAtacadao['DIFERENCA'] = analiseStAtacadao['VALOR ST ATACADÃO'] - analiseStAtacadao[
            'Valor icms sefaz']
        ...
        frame_fora_mes = frameOriginal.loc[(frameOriginal['Código Receita'] == 1031) |
                                           (frameOriginal['Código Receita'] == 2020)
                                           ]
        ...
        # -------- frame fornecedor UNILEVER --------

        frame_unilever = analiseStAtacadao.loc[
            (analiseStAtacadao['CNPJ'] == '61.068276/0159-85') | (analiseStAtacadao['CNPJ'] == '61.068.276/0007-91')]
        ...
        frame_retido_fornecedor.to_excel(writer, sheet_name='RETIDO_FORN', index=False)
        frame_unilever.to_excel(writer, sheet_name='UNILEVER', index=False)
