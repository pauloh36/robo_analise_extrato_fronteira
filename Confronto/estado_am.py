...
class Estado_am:
    ...
    def logica_am(self, arquivo_atual, caminho_arquivo, caminho_nfs_nao_efetivadas, filial_filtro, df_save):
        ...
        receita_1313 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 1313.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
            )

        receita_1380 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 1380.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
            )

        receita_1355 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 1355.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
            )

        receita_3863 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 3863.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
        ...
        receita_3961 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 3961.0, ['Número nota', 'Valor icms sefaz']]
            .groupby(['Número nota', 'Valor icms sefaz'])
            .sum()
            )
        ...
        soma_cods_sefaz = [receita_1313, receita_1380, receita_1355, receita_3863, receita_3961]
        ...
        frame_fora_mes = frameOriginal.loc[(frameOriginal['Código Receita'] == 1313) |
                                           (frameOriginal['Código Receita'] == 1380) |
                                           (frameOriginal['Código Receita'] == 3961) |
                                           (frameOriginal['Código Receita'] == 3863) |
                                           (frameOriginal['Código Receita'] == 1355)
                                           ]
