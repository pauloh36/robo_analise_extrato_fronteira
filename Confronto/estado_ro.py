...
class Estado_ro:
    ...
    def logica_ro(self, arquivo_atual, caminho_arquivo, caminho_nfs_nao_efetivadas, filial_filtro, df_save):
        ...
        receita_1231 = (analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 1231.0  , ['Número nota', 'Valor icms sefaz' ]]
                  .groupby(['Número nota' ,'Valor icms sefaz'])
                  .sum()
                )


        soma_cods_sefaz = [receita_1231]
        ...
        frame_fora_mes = frameOriginal.loc[(frameOriginal['Código Receita'] == 1231) 
                                           ]
