...
class Estado_se:
    ...
    def logica_se(self, arquivo_atual, caminho_arquivo,caminho_nfs_nao_efetivadas, filial_filtro, df_save):
        e = Estado_se()
        ...
        receita_708 = (
            analiseStSefaz.loc[analiseStSefaz['Código Receita'] == 708.0, ['Número nota', 'Valor icms sefaz']]
        ...
        somaStAtacadao715 = somaStAtacadao715.rename(columns={'Valor icms atacadao': 'ATACADAO ANTECIPADO'})
        ...
        analiseStAtacadao['OBS'] = ''

        analiseStAtacadao = analiseStAtacadao[
            ['Origem nota fiscal', 'CFOP', 'Número nota', 'CNPJ', 'Razão social', 'Valor icms sefaz',
             'VALOR ST ATACADÃO', 'DIFERENCA', 'OBS', 'ATACADAO ANTECIPADO']]
        ...
        frame_fora_mes = frameOriginal.loc[(frameOriginal['Código Receita'] == 708)]
